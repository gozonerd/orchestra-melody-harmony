<svelte:head>
	<title>Privacy Policy — Orchestra Melody & Harmony</title>
	<meta name="description" content="Privacy policy for Orchestra Melody & Harmony" />
</svelte:head>
...
<div class="mx-auto max-w-5xl px-6 py-12">
	...
	<div class="space-y-6 text-zinc-300">
		...
		<section>
			<h2 class="mb-3 text-xl font-semibold">Analytics</h2>
			<p>
				We use Vercel Analytics to track basic usage metrics (page views, performance). No personal
		...
		<section>
			...
			<p>We do not use cookies or any form of persistent user tracking.</p>
		</section>
